...
def load_chromsizes(chromsizes_filename, assembly=None):
    ...
    if chromsizes_filename is not None:
        ...
        if assembly is None:
            raise ValueError("No assembly or chromsizes specified. Please specify an assembly using the --assembly parameter or a set of chromsizes using the --chromsizes-filename parameter")
